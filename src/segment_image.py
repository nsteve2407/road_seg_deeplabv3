...
class Segmenter():
    ...
    def img_cb(self,image_msg):
        ...
        img_c = img_c[:320,:,:]
        image_tensor = tf.convert_to_tensor(img_c)
        ...
        segmented_image = self.get_overlay(img_c,rgb_mask)
        segmented_image = bridge.cv2_to_imgmsg(segmented_image,"bgr8")
        self.img_publisher.publish(segmented_image)
...
def main():
    ...
    weights_file  = "/home/mkz/catkin_ws/src/road_seg_deeplabv3/weights/kitti_weights_best.h5"
